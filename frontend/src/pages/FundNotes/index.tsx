...
export default function FundNotesPage() {
  ...
  const columns = [
    { title: '日期', dataIndex: 'period_date', key: 'period_date', width: 110 },
    { title: '公司', dataIndex: 'company_name', key: 'company_name', width: 120 },
    { title: '账户', dataIndex: 'account_display', key: 'account_display', width: 140 },
    {
      title: '变化方向', dataIndex: 'direction', key: 'direction', width: 100,
      render: (v: string) => v ? (
    ...
    { title: '变化金额', dataIndex: 'amount_change', key: 'amount_change', width: 140, align: 'right' as const, render: (v: number, r: any) => v != null ? fmtMYR(v, r.currency) : '-' },
    { title: '原因备注', dataIndex: 'notes', key: 'notes', ellipsis: true },
  ...
  return (
    ...
    >
      ...
      <Modal title={editing ? '编辑备注' : '新增变动备注'} open={modalOpen} onOk={onSave} onCancel={() => setModalOpen(false)} width={520}>
        <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
          <Form.Item name="period_date" label="日期 / 周期" rules={[{ required: true }]}><DatePicker style={{ width: '100%' }} /></Form.Item>
          ...
          <Form.Item name="amount_change" label="变化金额">
