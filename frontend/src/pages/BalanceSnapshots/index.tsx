...
export default function BalanceSnapshotsPage() {
  ...
  return (
    <Card
      ...
      extra={
        <Space>
          <Select placeholder="筛选公司" allowClear style={{ width: 160 }}
    ...
    >
      ...
      <Modal
        ...
        width={1020}
      >
        <Form form={batchForm} layout="inline" style={{ marginTop: 16 }}>
          {/* Shared header */}
          <div style={{ display: 'flex', gap: 16, marginBottom: 16, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <Form.Item name="data_source" label="数据来源" style={{ marginBottom: 0 }}>
              <Select options={DATA_SOURCE_OPTIONS} style={{ width: 130 }} />
            </Form.Item>
            <span style={{ color: '#7A5C44', fontSize: 12 }}>以下各行共用相同日期与来源</span>
          </div>
          ...
          <Button
            type="dashed" icon={<PlusOutlined />} onClick={addRow}
      ...
      {/* ── Single Edit Modal ── */}
      <Modal title="修改余额快照" open={editModal} onOk={onEditSave} onCancel={() => setEditModal(false)} width={480}>
